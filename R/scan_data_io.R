...
utils::globalVariables(c(
  ...
  "file_name", "generating_script", "has_token_str", "here_path",
  "heuristic_path", "infile_path", "input_dir", "input_file",
  "input_file_from_path", "input_file_tokens", "is_strong_read", "key_match",
  "key_matches", "line", "line_number", "m", "m_time", "outfile_path",
  "output_dir", "output_file", "output_file_from_path", "output_file_tokens",
  "path", "pattern", "read_pattern", "uname", "workflow_input",
  "write_from_code", "write_pattern"
))
