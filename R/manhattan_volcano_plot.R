...
#' @param alpha Significance threshold for the reference line/shading
#'   (default \code{0.05}).
#' @param highlight_significant Logical (default \code{TRUE}); shade the
#'   region above the \code{p < alpha} line.
...
manhattan_plot <- function(.data, var, log_p, alpha = 0.05, highlight_significant = TRUE) {
...
volcano_plot <- function(.data, log2_fold_change, log_p, var, alpha = 0.05, highlight_significant = TRUE) {
