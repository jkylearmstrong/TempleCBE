...
- **[`TempleCBE`](https://github.com/jkylearmstrong/TempleCBE)**: Open-source biostatistical, EDA, testing, and modeling utilities.
- **[`pslongSim`](https://github.com/jkylearmstrong/pslongSim)**: Longitudinal propensity score simulation framework for generating synthetic clinical trial datasets.
